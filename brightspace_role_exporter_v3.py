...
# --- SIDEBAR ---
with st.sidebar:
    st.header("📊 Roles/Permissions Analysis")
    st.info("Download and use the template below to use the ZIP file generated by this tool to inform the fuller Roles&Permissions Reporting")
    try:
